...
namespace Du.SolidWorks.Extension
{
    ...
    {
        private readonly ISelectionMgr _selecMgr;
        ...
        /// </summary>
        /// <returns></returns>
        public IComponent2 GetSelecComp()
        {
            return _selecMgr.GetSelectedObjectsComponent4(Index, Mark);
        }
    ...
    /// <summary>
    /// Extension Methods for <see cref="ISelectionMgr"/>
    /// </summary>
    public static class SelectionManagerExtensions
    {
        ...
        public static List<ObjectSelection> GetAllSelectedObjectsEx(this ISelectionMgr selMgr)
        {
            ...
            for (int i = 1; i < count+1; i++)
            {
                ...
                swSelectType_e swSelectType_E = (swSelectType_e)selMgr.GetSelectedObjectType3(i, AnyMark);
                object obj = selMgr.GetSelectedObject6(i, AnyMark);
                objList.Add(new ObjectSelection(obj, swSelectType_E, selMark, i,ref selMgr));
            }
            return objList;
        }
