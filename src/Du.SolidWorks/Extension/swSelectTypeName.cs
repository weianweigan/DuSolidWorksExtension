...
namespace Du.SolidWorks.Extension
{
    public class swSelectTypeName
    {
        ...
        /// <summary>
        /// See <see cref="Feature"/> Or <see cref="ICThread4"/> || SeeAlso SpecificData <seealso cref="ICosmeticThreadFeatureData"/>
        /// </summary>
        ...
        public const string swSelEXPLVIEWS = "EXPLODESTEPS";
