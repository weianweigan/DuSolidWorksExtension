...
namespace Du.SolidWorks.Extension
{
    public static class ICurveExtension
    {
        ...
        /// 圆形参数
        /// </summary>
        /// <param name="curve">ICurve Interface</param>
        /// <returns> [ center.x, center.y, center.z, axis.x, axis.y, axis.z, radius ]</returns>
        public static double[] GetCircleParams(this ICurve curve)
        {
            return curve.CircleParams as double[];
        }
    }
